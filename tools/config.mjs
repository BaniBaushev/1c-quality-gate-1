...
export const DEFAULTS = {
  ...
  artifacts: { pairs: [] },
  // Имена, которые в этом проекте означают ссылку, но конвенции «…Ссылка» не подчиняются.
  // Плагин их не угадывает и угадывать не должен: список доменный, у каждой конфигурации свой.
  // Пустой список — это выключенный ярус C, и в след он попадает сам: секция не переопределена,
  // значит `config=default`, и «чисто» по правилу не выдаёт себя за проверку по словарю.
  refDotAccess: { refNames: [] },
};
