...
Использовать `Соответствие` как кеш для дорогих операций в цикле — см. `bsl-anti-patterns.md` п.9.

### 6. Батчинг клиент-серверных переходов

Собирать данные на клиенте, передавать одним вызовом — см. `bsl-anti-patterns.md` п.6.
