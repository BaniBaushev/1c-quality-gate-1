...
связанность модулей · дублирование и диспетчеризация · переусложнение (обратная сторона).
...
severity. Опровергнутые не выбрасываются молча — они попадают в отчёт отдельным списком с
