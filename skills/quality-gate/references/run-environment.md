...
Сначала `installed_plugins.json` — указатель на **активную** версию, который ведёт сам
Claude Code. Перебор каталогов кэша — только запасной путь, и обязательно через `sort -V`.
